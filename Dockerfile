...
ARG RELEASE_TAG
ARG RELEASE_ORG="bhojpur.net"
ARG OPENVSCODE_SERVER_ROOT="/home/${RELEASE_TAG}"

# Downloading the latest OpenVSCode Server release and extracting the release archive
...
RUN chmod g+rw /home && \
    ...
    chown -R $USERNAME:$USERNAME /home/application && \
